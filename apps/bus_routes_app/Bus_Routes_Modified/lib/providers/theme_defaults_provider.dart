...
final themeDefaultsProvider =
    Provider<ThemeDefaultsProvider>((ref) => throw UnimplementedError());

class ThemeDefaultsProvider extends ChangeNotifier {
  ThemeDefaultsProvider();

  static late final TextStyles textStyles;
  TextStyles get getTextStyles => textStyles;

  static late final AppDefaults appDefaults;
  AppDefaults get getAppDefautls => appDefaults;
